            ...
            <div class="create-post">
            	<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="texts" id="exampleTextarea" cols="30" rows="10" class="form-control" placeholder="Write what you wish"></textarea>
                  </div>
                </div>
